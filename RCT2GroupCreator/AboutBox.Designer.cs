namespace RCT2GroupCreator {
	partial class AboutBox {
		...
		private void InitializeComponent() {
			...
			this.rctLabel2.Text = "RCT2 Group Creator";
			...
			// pictureBox1
			// 
			this.pictureBox1.Image = global::RCT2GroupCreator.Properties.Resources.AboutImage;
			...
			this.Text = "About RCT2 Group Creator";

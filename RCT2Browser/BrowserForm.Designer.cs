...
namespace RCTDataEditor {
	partial class BrowserForm {
		...
		private void InitializeComponent() {
			...
			this.tabGroupSettings.Controls.Add(this.label10);
			this.tabGroupSettings.Controls.Add(this.textBoxDirectory);
			this.tabGroupSettings.Controls.Add(this.label3);
			...
			this.buttonBrowseDefault.Location = new System.Drawing.Point(108, 13);
			...
			// 
			this.numericUpDownObjectsPerTick.Location = new System.Drawing.Point(107, 72);
			...
			this.label10.Text = "Objects Per Tick:";
			// 
			// textBoxDirectory
			// 
